...
public class Login extends AutoTestBase{
	...
	public static void startApp()
	{
		...
		if(platformName.toLowerCase().contains("ios"))
        {
			...
			appOperate.click(elements_StartPage_Host.HostAppIDclick, " 选定 appid   ");
	...
	//		 Log.logInfo("页面元素如下："+driver.getPageSource());
		...
		//	 appOperate.click(driver.findElement(By.xpath("//*[@value='"+login_HostName+"']")), "选择宿主登陆账号");
			 ...
			 {
				 appOperate.click(driver.findElement(By.name(login_HostName)), "点击 输入宿主账号");
			 }
		...
		int ii=0;
		 while(true)
		 {
	    	 ...
	    	 {	
		    	 ...
		    	 {	
					 appOperate.click(driver.findElement(By.name("烦死我了")), "点击 烦死我了");
		    	 }
